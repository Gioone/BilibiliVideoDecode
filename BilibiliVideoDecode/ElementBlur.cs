using BilibiliVideoDecode.Native;
using System;
...
{
    public class ElementBlur
    {
        public static readonly DependencyProperty IsEnabledProperty = DependencyProperty.RegisterAttached(
            "IsEnabled", typeof(bool), typeof(ElementBlur),
        ...
        public static readonly DependencyProperty WindowBlurProperty = DependencyProperty.RegisterAttached(
            "WindowBlur", typeof(ElementBlur), typeof(ElementBlur),
            new PropertyMetadata(null, OnWindowBlurChanged));

        public static void SetWindowBlur(DependencyObject element, ElementBlur value)
        {
            element.SetValue(WindowBlurProperty, value);
        }

        public static ElementBlur GetWindowBlur(DependencyObject element)
        {
            return (ElementBlur)element.GetValue(WindowBlurProperty);
        }
        ...
        private static void OnWindowBlurChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is Window window)
            {
                (e.OldValue as ElementBlur)?.Detach();
                (e.NewValue as ElementBlur)?.Attach(window);
            }
        }
